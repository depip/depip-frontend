...
const Page: NextPageWithLayout = () => {
  ...
  return (
    <section className="">
      <div className="lg:p-4 mx-auto max-w-screen-2xl">
        ...
        <div className="w-full mt-4 bg-gray-50 rounded-lg shadow-md dark:bg-gray-700">
          <div className="relative h-[calc(100vh-300px)]">
            <div className="p-8 h-[calc(100%-59px)] overflow-auto">
            ...
            <div className="px-4 py-2 flex gap-2 items-center border-t rounded-b-lg w-full bg-white absolute bottom-0 left-0 dark:border-t-gray-900 dark:bg-gray-900">
              <input
                type="text"
                placeholder="Type your message..."
                className="bg-gray-50 border border-gray-300 focus:border-blue-500 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500"
